        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="https://github.com/MrShadow009/Blockchain-Simulator.git" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                GitHub
              </a>
            </div>
            <div className="flex items-center space-x-4">
              <ModeToggle />
              <a href="https://symphony.iohk.io">
                <Button variant="outline">3D Simulator</Button>
              </a>
              <Link href="/simulator">
        ...
        <section className="relative overflow-hidden py-24 text-center">
          ...
          >
            ...
            <div className="flex justify-center flex-wrap gap-4">
              ...
              <a href="https://github.com/MrShadow009/Blockchain-Simulator.git" target="_blank" rel="noreferrer">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-primary/50 hover:bg-primary/10 px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105"
